...
namespace Sirenix.OdinInspector.Demos.RPGEditor
{
    ...
    public class CharacterSelector
    {
        ...
        private readonly List<Character> allCharacters;

        public Character this[int index]
        {
            get { return this.allCharacters[index]; }
        }

        public CharacterSelector(IEnumerable<Character> characters)
        {
            this.allCharacters = characters.ToList();
        }
        ...
        private class CharacterWrapper
        {
            ...
            [ShowInInspector, ProgressBar(0, 100)]
            public float Social { get { return this.character.Skills.Prestige; } set { this.character.Skills.Prestige = value; EditorUtility.SetDirty(this.character); } }
